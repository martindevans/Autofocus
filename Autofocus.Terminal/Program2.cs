...
//{
//    var normImage = Image.Load(frame);
//    var normImg = normImage.ToEncodedImage();
...
//           .Invert();
//    });
//    var maskImg = normMask.ToEncodedImage();
//    normMask.SaveAsPng($"masks_output/mask_img_{frameNum}.png");
...
//        prevFrame.ToImage().SaveAsPng($"frames_output/{frameNum++}.png");
//    }
//    else
//    {
